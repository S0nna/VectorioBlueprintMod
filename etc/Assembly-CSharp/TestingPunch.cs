...
public class TestingPunch : MonoBehaviour
{
	...
	// Token: 0x06000014 RID: 20 RVA: 0x000029DC File Offset: 0x00000BDC
	private void Update()
	{
	...
	// Token: 0x06000015 RID: 21 RVA: 0x00002F78 File Offset: 0x00001178
	...
	// Token: 0x06000017 RID: 23 RVA: 0x00002FFA File Offset: 0x000011FA
	private void updateColor(Color c)
	{
		GameObject.Find("LCharacter").GetComponent<Renderer>().material.color = c;
	}

	// Token: 0x06000018 RID: 24 RVA: 0x00003018 File Offset: 0x00001218
	...
	// Token: 0x06000019 RID: 25 RVA: 0x0000304E File Offset: 0x0000124E
